...
I'm an **AI Engineer and AI Application Developer** based in Hyderabad, India. I design and ship **agentic AI systems and full-stack AI products end to end**, from LLM orchestration and retrieval to APIs, apps and payments.

```python
class Kartikeya:
    role       = ["AI Engineer", "AI Application Developer", "SDE 1"]
    focus      = ["LLM agents", "RAG", "Tool calling", "Fine-tuning", "Evals"]
    ships_with = ["LangGraph", "NestJS", "FastAPI", "Next.js", "Flutter"]
    education  = "B.Tech, Computer Science & Machine Learning"
    currently  = "Building production AI agents and backend systems"
```

- 🏆 Hackathons: **1st** College MicroProject · **2nd** Zenith 2024 · **3rd** Zignas 2023
- 🌱 Core member at GDSC MLRIT, where I mentored 150+ students in Flutter
- 🎥 I document building products on [YouTube](https://www.youtube.com/@ISOLATED_MAN_)
...
<table>
  <tr>
    ...
    <td><img src="https://skillicons.dev/icons?i=ts,js,python,dart,java,swift&theme=dark" /></td>
  </tr>
  <tr>
    <td><b>Backend</b></td>
    <td><img src="https://skillicons.dev/icons?i=nestjs,fastapi,django,nodejs,express&theme=dark" /></td>
  </tr>
  <tr>
    <td><b>Frontend & Mobile</b></td>
    <td><img src="https://skillicons.dev/icons?i=nextjs,react,tailwind,flutter&theme=dark" /></td>
  </tr>
  <tr>
    <td><b>Databases</b></td>
    <td><img src="https://skillicons.dev/icons?i=postgres,supabase,firebase,redis,mongodb&theme=dark" /></td>
  </tr>
  <tr>
    <td><b>Cloud & DevOps</b></td>
    <td><img src="https://skillicons.dev/icons?i=docker,gcp,vercel,githubactions,git,postman&theme=dark" /></td>
  </tr>
</table>
...
### QuickValid.AI
AI startup-idea validator on the Play Store. A **LangGraph** engine runs risk, market and competitor analysis in parallel, grounded in live search, and streams the verdict over **SSE**.

`300+ users` `paying customers`
...
### Agenix
Autonomous **Slack → Jira agent**. It does semantic ticket search with **pgvector**, handles multi-workspace OAuth with AES-256-GCM token encryption, and runs a custom tool-calling agent runtime.
...
### MirrorCut
AI haircut try-on. Upload a selfie, **preview realistic hairstyles on your own face**, and get a barber-ready style card.
...
### GitPool
**Gamified leaderboard for GitHub organizations.** It turns commits, PRs, reviews and issues into a live competitive dashboard.
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/ISOLATEDMAN/ISOLATEDMAN/output/github-snake-dark.svg" />
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/ISOLATEDMAN/ISOLATEDMAN/output/github-snake.svg" />
    <img alt="Contribution snake" src="https://raw.githubusercontent.com/ISOLATEDMAN/ISOLATEDMAN/output/github-snake-dark.svg" />
  </picture>
</p>
